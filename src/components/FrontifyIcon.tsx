// NB - this is based on the iconNook from @frontify/fondue-icons, but is used to avoid the React version mismatch with the npm package
import React from 'react'

export const FrontifyIcon: React.FC = () => {
  return (
    <svg
